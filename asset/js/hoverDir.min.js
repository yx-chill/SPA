...
(function (factory) {
  ...
  function Hoverdir(element, options) {
    ...
    this.transitionProp = 'all ' + this.options.speed + 'ms ' + this.options.easing + ', opacity ease-in 350ms';;
    ...
    _showHover: function () {
      ...
      this.tmhover = setTimeout($.proxy(function () {
        this.$hoverElem.show(0, $.proxy(function () {
          if (this.support) {
            this.$hoverElem.css({
              'transition': this.transitionProp,
              'opacity': 1
            })
          }
...
$(document).ready(function ($) {
  ...
  function hoverdirInit() {
    if ($(window).width() >= 1184) {
      $('#hover-dir-wrap .work-grid-item').hoverdir({
        hoverElem: '.work-title',
        speed: 600,
